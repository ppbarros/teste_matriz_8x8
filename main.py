...
# f7=[]
# print(matrix)
f7 = [105.71, 43.28, 20.85, 16.76, 17.23, 18.42, 24.33, 25.85]
# for c in matrix:
#     c /= 21
#     f7.append(c)
#
...
f0 = [19.4, 45, 71.1, 71.3, 69.5, 71.6, 33, 2.4]
f1 = [8, 17.6, 24, 11.2, 12.8, 12.8, 19.2, 39.2]
f2 = [50.1, 71.35, 42.85, 38.85, 38.4, 68.75, 98.3, 103.5]
f3 = [16.8, 36.6, 57.6, 96, 116.8, 61.6, 36, 30.4]
f4 = [45.4, 84.9, 96.8, 184.9, 258.3, 68, 5.2, 4.2]
f5 = [70.85, 77.05, 98.25, 85.25, 61.55, 35.05, 84.15, 47.05]
f6 = [36.8, 42.4, 4, 8.8, 16.8, 4.8, 42.4, 43.2]
f8 = [32, 63, 63.8, 55.8, 74.8, 76.35, 70.55, 48.4]
f9 = [112.5, 128.25, 120.25, 96.5, 112.5, 128.12, 112.12, 96.37]
